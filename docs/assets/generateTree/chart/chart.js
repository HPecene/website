function generateTree(treeData) {
    ...
    function update(source) {
        ...
        nodeEnter.append("circle")
            .attr("r", 1e-6)
            .style("fill", function(d) { if (!d.children) { return "#00e676" } })
            .style("stroke", function(d) { if (!d.children) { return "#4a148c" } });

        nodeEnter.append("text")
            .attr("x", function(d) { return d.children || d._children ? 25 : -8; })
            .attr("dy", "40px")
